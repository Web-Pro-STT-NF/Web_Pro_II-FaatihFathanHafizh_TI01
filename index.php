...
$data = [
    [
        "id" => 1,
        "kode" => "P001",
        "tgl_periksa" => "2022-04-15",
        "nama" => "rendy",
        "tmp_lahir" => "Depok",
        "tgl_lahir" => "2002-05-04",
        "email" => "rendykece@gmail.com",
        "gender" => "L",
        "berat" => 71.8,
        "tinggi" => 169,
    ],
    [
        "id" => 2,
        "kode" => "P002",
        "tgl_periksa" => "2022-04-16",
        "nama" => "Lesti",
        "tmp_lahir" => "Tangerang",
        "tgl_lahir" => "2002-01-11",
        "email" => "Lestijor@gmail.com",
        "gender" => "P",
        "berat" => 60.3,
        "tinggi" => 162,
    ],
    [
        "id" => 3,
        "kode" => "P003",
        "tgl_periksa" => "2022-04-17",
        "nama" => "gilang",
        "tmp_lahir" => "Bandung",
        "tgl_lahir" => "2000-01-01",
        "email" => "gilangboz@gmail.com",
        "gender" => "L",
        "berat" => 50.2,
        "tinggi" => 171,
    ]
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Project UTS Individual</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-12 col-md-8 col-lg-8">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title" input type ="color" value="#16db44">Form BMI</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="#" method="POST">
                            ...
                            <!-- /.card-body -->
                            <div class="card-footer" input type="red">
